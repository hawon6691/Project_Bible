...
> 대상: `BackEnd/TypeScript/typescript-nest-npm-typeorm-postgresql` 백엔드 운영 및 장애 대응
> 기준일: 2026-02-23
...
- `e2e-critical-report` 아티팩트
  - `BackEnd/TypeScript/typescript-nest-npm-typeorm-postgresql/test-results/e2e-critical-report.json`
- `perf-smoke-artifacts` 아티팩트
  - `BackEnd/TypeScript/typescript-nest-npm-typeorm-postgresql/test-results/perf-smoke-summary.json`
  - `BackEnd/TypeScript/typescript-nest-npm-typeorm-postgresql/perf-server.log`
