...
| orders        | recipient\__, address_   | 주문 생성 시                | 배송지 변경 영향 차단 |
...
1. `BackEnd/TypeScript/typescript-nest-npm-typeorm-postgresql/src/**/entities/*.entity.ts`
2. `BackEnd/TypeScript/typescript-nest-npm-typeorm-postgresql/src/database/migrations/*`
3. 본 ERD 문서
