...
about: 새로운 기능 제안
title: "[FEAT] Release Gate 실행 요약(Step Summary) 추가"
labels: feature
issue: "[FEAT] Release Gate 실행 요약(Step Summary) 추가"
commit: "feat: (#199) release-gate 실행 결과를 GITHUB_STEP_SUMMARY에 기록"
branch: "feat/#199/release-gate-step-summary"
assignees: ""
---
