...
about: 새로운 기능 제안
title: "[FEAT] Release Gate 결과 아티팩트 업로드 추가"
labels: feature
issue: "[FEAT] Release Gate 결과 아티팩트 업로드 추가"
commit: "feat: (#197) release-gate 실행 결과 JSON 아티팩트 업로드 구성"
branch: "feat/#197/release-gate-artifact-report"
assignees: ""
---
